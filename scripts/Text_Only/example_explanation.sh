...
# 定义参数，路径都相对于项目根目录
MODEL_NAME="GPT-4o" # Qwen2.5-Omni/Qwen2.5-VL/Gemini2.5-flash/GPT-4o/InterVL 3.5/Minicpm 2.6-o/video SALMONN 2
VIDEO_DIR="./all_data" # 假设视频在这个目录
QUESTIONS_CSV="./all_data.csv"
CAND_FILE="./results_description_only/explanation/gpt4o.csv" # 模型输出的结果
REF_FILE="./all_data.csv" # 假设参考文件在这个目录
OUTPUT_CSV="./metric_description_only/explanation/gpt4o.csv" # 模型和标准答案之间的评估结果
TASK="explanation" # 任务
...
python ./eval/run_eval_description.py \
