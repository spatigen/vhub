...
# 定义参数，路径都相对于项目根目录
MODEL_NAME="GPT-4o"
VIDEO_DIR="./all_data_silent" # 假设视频在这个目录
QUESTIONS_CSV="./all_data.csv"
CAND_FILE="./results_video_only/explanation/gpt4o.csv" # 模型输出的结果
REF_FILE="./all_data.csv" # 假设参考文件在这个目录
OUTPUT_CSV="./metric_video_only/explanation/gpt4o.csv" # 模型和标准答案之间的评估结果
TASK="explanation" # 任务
